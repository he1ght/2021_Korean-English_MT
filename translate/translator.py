...
import inputters as inputters
# import decoders.ensemble
from translate.beam_search import BeamSearch, BeamSearchLM
from translate.greedy_search import GreedySearch, GreedySearchLM
from utils.misc import tile, set_random_seed, report_matrix
from utils.alignment import extract_alignment, build_align_pharaoh
...
class Inference(object):
    ...
    def translate(
        ...
        xlation_builder = translate.TranslationBuilder(
            data,
            self.fields,
            self.n_best,
            self.replace_unk,
