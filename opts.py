...
from position_ffn import ACTIVATION_FUNCTIONS
from position_ffn import ActivationFunction
...
def model_opts(parser):
    ...
    # Token Weight sharing & Customizing
    group = parser.add_argument_group('Semantic')
    group.add('--share_rank', '-share_rank',
              type=str, default="all", choices=["all", "flayer", "fattn"])
